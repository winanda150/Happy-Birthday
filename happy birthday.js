  ...
  if (this.phase === "firework") {
    if (!this.spawned) {
      ...
      var linearProportion = this.tick / this.reachTime,
        ...
        x = linearProportion * this.x - fireworkOffsetX,
...
// Mencegah interaksi pada kontrol audio
...
tombol.addEventListener('click', function(e) {
  if (isDebouncing) return; // abaikan klik jika sedang debounce
  isDebouncing = true;
...
function getIsDesktopModeOnMobile() {
  // Jika device mobile tapi lebar layar sangat besar, kemungkinan mode desktop
  return getIsMobile() && window.innerWidth > 900;
}
function applyMinimumSize() {
  // Batasi minimum ukuran font dan kanvas
