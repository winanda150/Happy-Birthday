...
// kode untuk tombol suara
const tombol = document.querySelector('.Tombol');
const audio = document.getElementById('audioTombol');

// event listener untuk hover dan klik tombol
if (tombol) {
  ...
  // animasi naik turun tombol
  tombol.addEventListener('animationend', function(e) {
    if (tombol.classList.contains('show')) {
    }
  });
  // menghilangkan audio
